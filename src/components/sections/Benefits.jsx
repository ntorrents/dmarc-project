...
import { Shield, TrendingUp, Eye, AlertTriangle, FileText, Wrench } from 'lucide-react'
...
const Benefits = () => {
  const benefits = [
    ...
    },
    {
      ...
      description: 'Enhance your email deliverability by implementing DMARC effectively.'
    },
    {
      icon: Eye,
      title: 'Full Visibility',
      description: 'Maintain complete visibility over email health and detect issues within your program.'
    },
    {
      icon: AlertTriangle,
      title: 'Reports & Alerts',
      description: 'Stay informed with periodic reports on DMARC compliance and security status.'
    },
    {
      icon: FileText,
      title: 'Forensic Reports',
      description: 'Track down emails that cause DMARC compliance failures with detailed analysis.'
    },
    {
      icon: Wrench,
      title: 'DNS Toolbox',
      description: 'Comprehensive tools to diagnose and fix DNS issues like SPF, DKIM, and DMARC.'
    }
  ]
