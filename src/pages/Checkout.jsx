...
const Checkout = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    console.log('Checkout submitted:', { plan: selectedPlan, billingCycle, formData })
  }
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              You're just one step away from securing your email communications
            </p>
          </motion.div>
              ...
              <div className="card sticky top-8">
                ...
                <div className="border-b border-gray-200 pb-6 mb-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">{selectedPlan} Plan</h3>
