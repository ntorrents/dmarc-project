	...
	const plans = [
		{
			...
			yearlyPrice: 490,
			description:
				"Perfect for small businesses getting started with email security",
			features: [
				"1 Domain",
				"1 User",
				...
				<div className="container-custom text-center">
					<motion.div
						...
						<p className="text-xl text-gray-300 max-w-3xl mx-auto">
							...
							our core email security features with 30-day money-back guarantee.
						</p>
					</motion.div>
				</div>
			</section>
							...
							<motion.div
								...
								<div
									className={`card h-full ${
										plan.popular ? "border-primary-200 shadow-xl" : ""
									}`}>
										...
										{features.map((category, categoryIndex) => (
											<React.Fragment key={category.category}>
												<tr className="bg-gray-50">
													<td
														colSpan={4}
														className="py-3 px-6 font-semibold text-gray-700 text-sm uppercase tracking-wide">
														{category.category}
													</td>
												</tr>
					...
					<motion.div
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
							...
							<div className="text-left">
								...
								<p className="text-gray-600">
									All plans include email support. Standard and Premium plans
									include chat and phone support.
								</p>
							</div>
							<div className="text-left">
								<h4 className="font-semibold text-gray-900 mb-2">
